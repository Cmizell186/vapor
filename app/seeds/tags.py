...
def seed_tags():
  ...
  tag13 = Tag(game_id = 13, genre_id = 1)
  tag14 = Tag(game_id = 16, genre_id = 1)
  tag15 = Tag(game_id = 17, genre_id = 1)

  db.session.add_all([tag1, tag2, tag3, tag4, tag5, tag6, tag7, tag8, tag9, tag10, tag11, tag12, tag13, tag14, tag15])
